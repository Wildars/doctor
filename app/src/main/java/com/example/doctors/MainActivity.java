...
public class MainActivity extends AppCompatActivity{
    ...
    void initList(){
        docs.add(new Doctor("Doctor1", "+996708760011","Окулист", R.drawable.doc));
        docs.add(new Doctor("Doctor2", "+996708760011","Психиатр", R.drawable.doc5));
        docs.add(new Doctor("Doctor3", "+996708760011","Хирург", R.drawable.doc1));
        docs.add(new Doctor("Doctor4", "+996708760011","Невропатолог", R.drawable.doc3));
        docs.add(new Doctor("Doctor5", "+996708760011","Окулист", R.drawable.doc4));
        docs.add(new Doctor("Doctor6", "+996708760011","Терапевт", R.drawable.doc2));
